# find-deep — a self-contained CLI-education clip
...
find-deep/
  ...
  find-deep.mp4 .srt .html   # the product
...
.venv/bin/python src/overlay.py               # -> ./find-deep.mp4 + .srt  (panel + J-cut)
...
python3 ~/.claude/skills/agent-demo-recorder/scripts/gen_html.py find-deep.mp4 -o find-deep.html
```
