# find — a self-contained CLI-education clip
...
.venv/bin/python src/overlay.py               # -> ./find.mp4 + .srt  (panel + J-cut)
...
python3 ~/.claude/skills/agent-demo-recorder/scripts/gen_html.py find.mp4 -o find.html
```
