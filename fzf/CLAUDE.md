# fzf — a self-contained CLI-education clip
...
.venv/bin/python src/overlay.py               # -> ./fzf.mp4 + .srt  (panel + J-cut)
...
python3 ~/.claude/skills/agent-demo-recorder/scripts/gen_html.py fzf.mp4 -o fzf.html
```
