# cp — a self-contained CLI-education clip
...
.venv/bin/python src/overlay.py               # -> ./cp.mp4 + .srt  (panel + J-cut)
...
python3 ~/.claude/skills/agent-demo-recorder/scripts/gen_html.py cp.mp4 -o cp.html
```
