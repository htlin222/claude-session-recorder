# df — a self-contained CLI-education clip
...
.venv/bin/python src/overlay.py               # -> ./df.mp4 + .srt  (panel + J-cut)
...
python3 ~/.claude/skills/agent-demo-recorder/scripts/gen_html.py df.mp4 -o df.html
```
