...
import clipkit                                 # S/R/CLR builders + lesson loader

# ROOT is the SELF-CONTAINED slug folder (src/ lives inside it). Everything this
# clip needs — lesson.py, config.toml, intermediate/, the product — is under ROOT,
...
# the ONE lesson in this folder supplies SCRIPT + SLUG/TITLE
_L = clipkit.load_lesson(f"{ROOT}/lesson.py")
