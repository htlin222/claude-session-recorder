# ssh — a self-contained CLI-education clip
...
.venv/bin/python src/overlay.py               # -> ./ssh.mp4 + .srt  (panel + J-cut)
...
python3 ~/.claude/skills/agent-demo-recorder/scripts/gen_html.py ssh.mp4 -o ssh.html
```
