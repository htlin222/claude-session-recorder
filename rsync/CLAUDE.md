# rsync — a self-contained CLI-education clip
...
rsync/
  ...
  rsync.mp4 .srt .html   # the product
...
.venv/bin/python src/overlay.py               # -> ./rsync.mp4 + .srt  (panel + J-cut)
...
python3 ~/.claude/skills/agent-demo-recorder/scripts/gen_html.py rsync.mp4 -o rsync.html
```
