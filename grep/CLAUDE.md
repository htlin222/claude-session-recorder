# grep — a self-contained CLI-education clip
...
.venv/bin/python src/overlay.py               # -> ./grep.mp4 + .srt  (panel + J-cut)
...
python3 ~/.claude/skills/agent-demo-recorder/scripts/gen_html.py grep.mp4 -o grep.html
```
