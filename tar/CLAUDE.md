# tar — a self-contained CLI-education clip
...
.venv/bin/python src/overlay.py               # -> ./tar.mp4 + .srt  (panel + J-cut)
...
python3 ~/.claude/skills/agent-demo-recorder/scripts/gen_html.py tar.mp4 -o tar.html
```
