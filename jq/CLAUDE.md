# jq — a self-contained CLI-education clip
...
.venv/bin/python src/overlay.py               # -> ./jq.mp4 + .srt  (panel + J-cut)
...
python3 ~/.claude/skills/agent-demo-recorder/scripts/gen_html.py jq.mp4 -o jq.html
```
