# awk — a self-contained CLI-education clip
...
.venv/bin/python src/overlay.py               # -> ./awk.mp4 + .srt  (panel + J-cut)
...
python3 ~/.claude/skills/agent-demo-recorder/scripts/gen_html.py awk.mp4 -o awk.html
```
