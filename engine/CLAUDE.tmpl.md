# {{SLUG}} — a self-contained CLI-education clip
...
.venv/bin/python src/overlay.py               # -> ./{{SLUG}}.mp4 + .srt  (panel + J-cut)
...
python3 ~/.claude/skills/agent-demo-recorder/scripts/gen_html.py {{SLUG}}.mp4 -o {{SLUG}}.html
```
